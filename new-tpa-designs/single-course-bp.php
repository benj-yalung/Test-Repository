          ...
          <div class="single-course_column single-course_content">
            <div class="single-course__head">
              ...
              <div class="single-course_header course-title">
                <p>Course</p>
                <h3>English in Practice: Business Proficiency
                </h3>
                <p>with Tammy R.</p>
              </div>
            ...
            <div  id="CourseHome" class="tab_content">
              <div class="course-content_wrapper">
                <div class="course-content course-description">
                  ...
                  <p>This course will further strengthen students’ usage of the English language while giving them a variety of ways to practice in real-life situations. This course will delve deeper into professional and business vocabulary and expressions relating to customer service, business presentations, professional emails, and more. </p>
                </div>
              </div>
            </div>
