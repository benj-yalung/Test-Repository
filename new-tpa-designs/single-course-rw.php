  ...
  <div class="main-wrapper">
    ...
    <main class="main users single-course-page" id="skip-target">
        <div class="single_course_wrapper">
          <div class="single-course_column single-course_content objective">
            ...
            <div  id="CourseHome" class="tab_content">
              <div class="course-content_wrapper">
                ...
                <div class="course-content course-objective">
                  <h3>Course Objectives</h3>
                  <ul>
                    <li>Resume and Cover Letter Creation </li>
                    <li>Legal Text and Contracts </li>
                    <li>Emails and Professional Communication </li>
                  </ul>
                </div>
              </div>
            </div>
